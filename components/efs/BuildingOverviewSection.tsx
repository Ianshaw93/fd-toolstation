...
export default function BuildingOverviewSection({ data, onChange }: BuildingOverviewSectionProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div>
        <label htmlFor="efs-has-suppression" className="block text-sm font-medium text-gray-700 mb-1">Has Suppression</label>
        <select
          id="efs-has-suppression"
      ...
      <div>
        <label htmlFor="efs-suppression-standard" className="block text-sm font-medium text-gray-700 mb-1">Suppression Standard</label>
        <select
          id="efs-suppression-standard"
      ...
      <div>
        <label htmlFor="efs-fire-alarm-category" className="block text-sm font-medium text-gray-700 mb-1">Fire Alarm &amp; Detection Category</label>
        <select
          id="efs-fire-alarm-category"
      ...
      <div>
        <label htmlFor="efs-investigation-period" className="block text-sm font-medium text-gray-700 mb-1">Investigation Period</label>
        <select
          id="efs-investigation-period"
      ...
      <div>
        <label htmlFor="efs-fire-resistance" className="block text-sm font-medium text-gray-700 mb-1">Required Fire Resistance (mins)</label>
        <input
          id="efs-fire-resistance"
          type="number"
